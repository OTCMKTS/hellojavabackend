...
module Acme
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['ACME_SESSIONS_SECRET']
      ...
      #
      layout :application # It will load Acme::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time Acme::Action is included
